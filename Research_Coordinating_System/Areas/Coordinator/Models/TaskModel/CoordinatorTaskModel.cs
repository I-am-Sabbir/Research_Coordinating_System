...
{
    public class CoordinatorTaskModel : TaskBaseModel
    {
        public CoordinatorTaskModel(ITaskService taskService, IUserService userService) : base(taskService, userService) { }
        public CoordinatorTaskModel() : base() { }
